...
public class ReVenta extends javax.swing.JFrame {
    ...
    public void reporte () {
        ...
        String[] tableColumnsName = {"No. Factura ","Cliente","Fecha", "Total_Compra"}; 
        ...
        try {
            ...
            String sql = "SELECT  fv.FacturaVentaID AS ID, c.NombreCliente AS Cliente, fv.Fecha AS Fecha, fv.TotalVenta AS Total_Compra " +
